...
namespace Com.MyCompany.MyGame
{
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        /// <summary>
        /// MonoBehaviour method called on GameObject
        /// by Unity during early initialization phase.
        /// </summary>
        ...
        public void Connect() // need
        {
            ...
            else
            {
                ...
                // keep track of the will to join a room,because when we come back
                // from the game we will get a callback that we are connected, so we need to
        ...
        public override void OnConnectedToMaster() // need
        {
        ...
        public override void OnDisconnected(DisconnectCause cause) // need
        {
            progressLabel.SetActive(false);
            controlPanel.SetActive(true);
        ...
        /*public override void OnJoinRandomFailed(short returnCode, string message) // May not need
        {
        ...
        public override void OnJoinedRoom() // need
        {
